...
function ImprovementBadge({ before, after, lowerIsBetter = true }: { before: number; after: number; unit?: string; lowerIsBetter?: boolean }) {
...
export function AuditDetailClient({ audit, id }: { audit: any; id: string }) {
  ...
  function handleShare() {
    const url = `${window.location.origin}/tools/performance-audit/${id}/share`;
    setShareLink(url);
